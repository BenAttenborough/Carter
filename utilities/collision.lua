...
function hasCollided(target, obstacle)
	...
	return target.left < obstacle.left + obstacle.width and
			obstacle.left < target.left + target.width and
			target.top < obstacle.top + obstacle.height and
			obstacle.top < target.top + target.height
